...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FdProfile.availibility'
        db.add_column('profiles_fdprofile', 'availibility', self.gf('django.db.models.fields.CharField')(default='immediately', max_length=15, null=True, blank=True), keep_default=False)

        # Adding field 'FdProfile.looking_for'
        db.add_column('profiles_fdprofile', 'looking_for', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)

        # Adding field 'FdProfile.education'
        db.add_column('profiles_fdprofile', 'education', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'FdProfile.brings'
        db.add_column('profiles_fdprofile', 'brings', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'FdProfile.current_idea'
        db.add_column('profiles_fdprofile', 'current_idea', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FdProfile.availibility'
        db.delete_column('profiles_fdprofile', 'availibility')

        # Deleting field 'FdProfile.looking_for'
        db.delete_column('profiles_fdprofile', 'looking_for')

        # Deleting field 'FdProfile.education'
        db.delete_column('profiles_fdprofile', 'education')

        # Deleting field 'FdProfile.brings'
        db.delete_column('profiles_fdprofile', 'brings')

        # Deleting field 'FdProfile.current_idea'
        db.delete_column('profiles_fdprofile', 'current_idea')
    ...
    models = {
        ...
        'profiles.applicant': {
            ...
            'fdprofile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['profiles.FdProfile']", 'null': 'True'}),
        ...
        'profiles.fdprofile': {
            ...
            'availibility': ('django.db.models.fields.CharField', [], {'default': "'immediately'", 'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'bio': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'bring_blurb': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'bring_skillsets_json': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'brings': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'building_blurb': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'can_start': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'comments': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'current_idea': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idea_status': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'interest_areas': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['profiles.Interest']", 'null': 'True', 'blank': 'True'}),
            'interests_json': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'linkedin_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'looking_for': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'mugshot': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'need_skillsets_json': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'past_experience_blurb': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'privacy': ('django.db.models.fields.CharField', [], {'default': "'registered'", 'max_length': '15'}),
            'skillsets': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['profiles.Skillset']", 'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
