...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FdProfile.availability'
        db.add_column('profiles_fdprofile', 'availability', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FdProfile.availability'
        db.delete_column('profiles_fdprofile', 'availability')
    ...
    models = {
        ...
        'profiles.fdprofile': {
            ...
            'availability': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
