...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Applicant.fdprofile'
        db.add_column('profiles_applicant', 'fdprofile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.FdProfile'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Applicant.fdprofile'
        db.delete_column('profiles_applicant', 'fdprofile_id')
