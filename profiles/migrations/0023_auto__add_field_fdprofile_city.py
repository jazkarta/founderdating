...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FdProfile.city'
        db.add_column('profiles_fdprofile', 'city', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FdProfile.city'
        db.delete_column('profiles_fdprofile', 'city')
